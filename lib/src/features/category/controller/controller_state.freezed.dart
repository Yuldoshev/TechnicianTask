...
abstract class $CategoryStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<CategoryModel> categoryList, bool isLoading});
}
...
class _$_CategoryState extends _CategoryState {
  ...
  @override
  String toString() {
    return 'CategoryState(categoryList: $categoryList, isLoading: $isLoading)';
  }
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_categoryList), isLoading);
...
abstract class _CategoryState extends CategoryState {
  const factory _CategoryState(
      ...
      final bool isLoading}) = _$_CategoryState;
